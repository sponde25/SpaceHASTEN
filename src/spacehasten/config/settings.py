...
class GeneralSettings(_Section):
    ...
    train_seed: int = 42
    train_warm_start: bool = True
    train_warm_epochs: int = 10
    train_warm_new_data_repeat: int = 2
    train_warm_warmup_epochs: int = 1
    train_warm_init_lr: float = 3e-5
    train_warm_max_lr: float = 3e-4
    train_warm_final_lr: float = 3e-5
    train_warm_early_stopping_patience: int = 10
