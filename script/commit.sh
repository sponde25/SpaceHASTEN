...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/Mpmw/_git/SpaceHASTEN.git
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/Mpmw/_git/SpaceHASTEN.git